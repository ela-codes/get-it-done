...
function buildContentonLoad() {
    ...
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_3__.loadOldTasks)(storedList)
...
addBtn.addEventListener("click", () => {
    ...
    const dateInput = document.querySelector('input[name="new-date"]')
    const currTask = new _task_js__WEBPACK_IMPORTED_MODULE_0__.Task(
        taskInput.value, 
        dateInput.value,
        false,
        (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.generateTaskID)(activeList.listName),
        false
    )

    activeList.addTask = currTask
    ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.saveListToStorage)(activeList)
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_3__.loadNewTasks)((0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.getStoredItems)(activeList.listName))
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_3__.updateTaskDisplayStatus)(currTask)
    ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.saveListToStorage)(activeList)
    CheckBoxListener()
})
