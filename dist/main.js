    ...
    function switchLists() {
        ...
        sidebarLists.forEach(list => list.addEventListener('click', () => {
            ...
            if (currList.classList[0] !== clickedItem) {
                ...
                addBtnListener()
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleDeleteListBtnDisplay)(currList.classList[0])
            }
        }))
    }
