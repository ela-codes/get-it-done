...
function applyListenersOnLoad() {
    ...
    function deleteBtnListener() {
        ...
        deleteBtns.forEach(btn => 
            ...
            deleteTask(btn, _index_js__WEBPACK_IMPORTED_MODULE_3__.activeList)
            })
        )
    }
    checkBoxListener()
...
function deleteCompleted() {
    ...
    btn.addEventListener('click', () => {
        ...
        checkboxes.forEach(box => {
            if (box.checked) {
                deleteTask(box, _index_js__WEBPACK_IMPORTED_MODULE_3__.activeList)
            }
        })
    })
}
...
// GLOBAL VARIABLES
const defaultList = new _list_js__WEBPACK_IMPORTED_MODULE_0__.List('Default')
let activeList = defaultList;


// ON WINDOW LOAD
window.onload = () => {
    (0,_userInterface_js__WEBPACK_IMPORTED_MODULE_2__.getTodaysDate)()
    ;(0,_eventListener_js__WEBPACK_IMPORTED_MODULE_3__.addBtnListener)()

    if (localStorage.length > 0) {
        buildContentOnLoad()
        ;(0,_eventListener_js__WEBPACK_IMPORTED_MODULE_3__.deleteCompleted)()
    } else {
        (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(activeList)
    }
}
...
function buildContentOnLoad() {
    const storedList = (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)(activeList.listName)
    activeList = storedList
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_2__.loadOldTasks)(activeList)
    ;(0,_eventListener_js__WEBPACK_IMPORTED_MODULE_3__.applyListenersOnLoad)()
