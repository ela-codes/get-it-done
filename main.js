...
function onWindowLoad() {
    window.onload = () => {        
        if (localStorage.length > 0) {
            ...
            (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(_index_js__WEBPACK_IMPORTED_MODULE_3__.defaultList)
            addBtnListener(_index_js__WEBPACK_IMPORTED_MODULE_3__.defaultList)
            applyListenersOnLoad(_index_js__WEBPACK_IMPORTED_MODULE_3__.defaultList)
        }
...
function buildContentOnLoad() {
    ...
    const storedList = (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)('Default')) 
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.loadOldTasks)(storedList)
    ...
    function newListListener() {
        ...
        addListBtn.addEventListener('click', () => {
            ...
            confirm.onclick = () => {
                ...
                const newList = _list_js__WEBPACK_IMPORTED_MODULE_4__.List.createNew(input.value)
                
                ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(newList)
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleModal)()
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.showList)(newList.name)
            }
        })
    }
...
let defaultList = _list_js__WEBPACK_IMPORTED_MODULE_1__.List.createDefault()
