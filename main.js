...
function buildContentOnLoad() {
    ...
    for (let listName of storedLists) {
        ...
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.showList)(currList.listName)
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.loadOldTasks)(currList)
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.addToSidebar)(currList.listName, currList.getProperName())
...
function addBtnListener(activeList) {
    ...
    addBtn.addEventListener('click', () => {
        ...
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.loadNewTasks)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(activeList.listName)))
...
function applyListenersOnLoad(activeList) {
    ...
    function newListListener() {
        ...
        addListBtn.addEventListener('click', () => {
            ...
            confirm.onclick = () => {
                const newList = _list_js__WEBPACK_IMPORTED_MODULE_3__.List.createNew(input.value)
                
                ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(newList)
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleModal)()
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.showList)(newList.listName)
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.addToSidebar)(newList.listName, newList.getProperName())
                refreshAddBtnListener()
...
function retrieveList(listName) {
    ...
    const newList = new _list_js__WEBPACK_IMPORTED_MODULE_0__.List(storedList.name, storedList.tasks)
...
class Task {
    ...
    static createNew(activeList) {
        ...
        const currTask = new Task(
            ...
            dateInput.value,
            false,
            (0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.generateTaskID)(activeList.listName),
            false
        )
        return currTask
    }
