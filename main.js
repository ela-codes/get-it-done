    ...
    function switchLists() {
        ...
        sidebarLists.forEach(list => list.addEventListener('click', () => {
            ...
            if (currList.classList[0] !== clickedItem) {
                ...
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleListDisplay)(currList)
...
function deleteTask(element, activeList) {
    ...
    (0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.removeTaskFromUI)(element.parentElement)
    console.log(element, activeList)
    activeList.deleteTask(element.id)
    ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(activeList)
    ;(0,_task_js__WEBPACK_IMPORTED_MODULE_2__.updateAllTaskID)(activeList)
    ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(activeList)
}
...
/* harmony export */   "removeTaskFromUI": () => (/* binding */ removeTaskFromUI),
