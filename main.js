...
addBtn.addEventListener("click", () => {
    ...
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_3__.updateTaskDisplayStatus)(activeList.latestTask())
    ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.saveListToStorage)(activeList)
...
function deleteBtnListener() {
    ...
    deleteBtns.forEach(btn => btn.addEventListener('click', () => {
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_3__.removeTaskFromUI)(btn.parentElement)
