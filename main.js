...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "onWindowLoad": () => (/* binding */ onWindowLoad)
/* harmony export */ });
...
function onWindowLoad() {
    window.onload = () => {        
        if (localStorage.length > 0) {
            ...
            let defaultList = _list_js__WEBPACK_IMPORTED_MODULE_3__.List.createDefault()
            ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(defaultList)
            buildContentOnLoad()
        }
        (0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.getTodaysDate)()
    }
}
...
function buildContentOnLoad() {
    ...
    function contentBuilder(listName) {
        const currList = (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(listName)) 
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.showList)(currList.listName, currList.properListName)
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.loadOldTasks)(currList)
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.addToSidebar)(currList.listName, currList.properListName)
        ...
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleDeleteListBtnDisplay)(currList.properListName)
    }
}
...
function newListListenerAfterLoad() {
    ...
    newListBtn.addEventListener('click', () => {
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleModal)()

        const confirm = document.querySelector('.confirm-name');
        const input = document.querySelector('input[name="new-list"]')
        const exit = document.querySelector('.exit');

        exit.onclick = () => (0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleModal)()

        confirm.onclick = () => {
            const newList = (0,_list_js__WEBPACK_IMPORTED_MODULE_3__.getNewList)(input.value)
            ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(newList)
            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleModal)()
            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.showList)(newList.listName, newList.properListName)
            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.addToSidebar)(newList.listName, newList.properListName)

            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleDeleteListBtnDisplay)(newList.properListName)
            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.clearInputField)(confirm.parentNode)
    ...
    function switchLists() {
        ...
        sidebarLists.forEach(list => list.addEventListener('click', () => {
            ...
            if (listDOMElement.classList[0] !== clickedItem) {
                ...
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleListDisplay)(listDOMElement)
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleListDisplay)(newList)
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.updateListHeader)(list.innerText)
                listDOMElement = document.querySelector('.checklist.active')

                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleDeleteListBtnDisplay)(listDOMElement.classList[0])
            }
        }))
    }
    ...
    function deleteNewList() {
        ...
        newBtn.addEventListener('click', () => {
            if (confirm('Are you sure you want to delete this list?')) {
                ...
                listDOMElement = document.querySelector('.checklist.active')
                ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.removeStoredList)(listDOMElement.classList[0])
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.removeFromUI)(listDOMElement)
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.removeFromUI)(listSidebar)

                const defaultList = document.querySelector('.checklist.Today')
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleListDisplay)(defaultList) // go back to default list
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.updateListHeader)(defaultList.classList[0]) 
                ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.toggleDeleteListBtnDisplay)(defaultList.classList[0]) 
            }
        })
...
function addBtnListenerAfterLoad() {
    ...
    newaddBtn.addEventListener('click', () => {
        ...
        const currList = (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(listDOMElement.classList[0])
        currList.addTask = _task_js__WEBPACK_IMPORTED_MODULE_2__.Task.createNew(currList)
        ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(currList)
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.loadNewTasks)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(currList.properListName)))
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.updateTaskDisplayStatus)(currList.latestTask())
        ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(currList)
        ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.clearInputField)(newaddBtn.parentNode)
        applyTaskListeners()
    })
}
...
function applyTaskListeners() {
    ...
    let listDOMElement = document.querySelector('.checklist.active')
    let activeList =  (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(listDOMElement.classList[0]))

    function checkBoxListener() {
        const checkBoxes = document.querySelectorAll('.active-cb')
    
        checkBoxes.forEach(box => box.addEventListener('change', () => {
            activeList =  (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.getStoredItems)((0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(listDOMElement.classList[0]))
            activeList.allTasks[box.id].currStatus = box.checked
            ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(activeList)
        }))
    }
    ...
    function deleteBtnListener() {
        ...
        deleteBtns.forEach(btn => 
            ...
            ;(0,_task_js__WEBPACK_IMPORTED_MODULE_2__.updateAllTaskID)(activeList.allTasks) // reassign consecutive task IDs to tasks in new list
            ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(activeList) // save changes to storage
            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.updateElementTaskID)(listDOMElement, activeList.totalLength())
            })
        )
    }
    ...
    function deleteCompletedListener() {
        ...
        newBtn.addEventListener('click', () => {
            activeList = (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.retrieveList)(document.querySelector('.checklist.active').classList[0])
            const checkboxes = document.querySelectorAll('.active-cb')
            ...
            ;(0,_task_js__WEBPACK_IMPORTED_MODULE_2__.updateAllTaskID)(activeList.allTasks)
            ;(0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveListToStorage)(activeList)
            ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.updateElementTaskID)(listDOMElement, activeList.totalLength())
        })
    }
...
function deleteTaskManager(element, activeList) {
    ...
    ;(0,_userInterface_js__WEBPACK_IMPORTED_MODULE_0__.removeFromUI)(element.parentElement)
}
...
/* harmony export */   "getNewList": () => (/* binding */ getNewList)
/* harmony export */ });
class List {
    constructor(name) {
        this.name = name;
...
/* harmony export */   "getStoredItems": () => (/* binding */ getStoredItems),
/* harmony export */   "removeStoredList": () => (/* binding */ removeStoredList),
/* harmony export */   "retrieveList": () => (/* binding */ retrieveList),
...
function saveListToStorage(listObj) {
...
function retrieveList(listName) {
    ...
    const newList = _list_js__WEBPACK_IMPORTED_MODULE_0__.List.createNew(storedList.properName)
    Object.assign(newList, storedList)
    return newList
}


function getStoredItems(currList) {
    const list = currList
    for (let i = 0; i < list.totalLength() ; i++ ) {
        const newTask = new _task_js__WEBPACK_IMPORTED_MODULE_1__.Task(
...
function generateTaskID(listName) { 
...
function removeStoredList(listName) {
...
/* harmony export */   "updateAllTaskID": () => (/* binding */ updateAllTaskID)
/* harmony export */ });
...
class Task {
    ...
    static createNew(activeList) {
        ...
        const currTask = new Task(
            ...
            dateInput.value,
            false,
            (0,_storage_js__WEBPACK_IMPORTED_MODULE_0__.generateTaskID)(activeList.properListName),
            false
        )
        return currTask
    }
...
/* harmony export */   "loadNewTasks": () => (/* binding */ loadNewTasks),
/* harmony export */   "loadOldTasks": () => (/* binding */ loadOldTasks),
/* harmony export */   "removeFromUI": () => (/* binding */ removeFromUI),
/* harmony export */   "showList": () => (/* binding */ showList),
/* harmony export */   "toggleDeleteListBtnDisplay": () => (/* binding */ toggleDeleteListBtnDisplay),
/* harmony export */   "toggleListDisplay": () => (/* binding */ toggleListDisplay),
/* harmony export */   "toggleModal": () => (/* binding */ toggleModal),
/* harmony export */   "updateElementTaskID": () => (/* binding */ updateElementTaskID),
/* harmony export */   "updateListHeader": () => (/* binding */ updateListHeader),
/* harmony export */   "updateTaskDisplayStatus": () => (/* binding */ updateTaskDisplayStatus)
/* harmony export */ });
...
function getTodaysDate() {
    const dateInput = document.querySelector('input[name="new-date"]');
    dateInput.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(Date.now(), 'yyyy-MM-dd');
}
...
function updateTaskDisplayStatus(task) {
    task.displayedStatus = task.displayedStatus? false : true ;
}


function removeFromUI(div) {
    div.remove()
}

function showList(listName, properName) {
...
function toggleListDisplay(div) {
...
function updateListHeader(listName) {
    const title = document.querySelector('.list-title');
    title.innerHTML = listName
}


function toggleDeleteListBtnDisplay(listName) {
    const btn = document.querySelector('.delete-list');
    if (listName !== 'Today') {
...
function addToSidebar(listName, properName) {
...
function clearInputField(parentNode) {
    const input = parentNode.querySelector('input[type="text"]')
    input.value = ''
}


function updateElementTaskID(activeListElement, totalTasks) {
    let num = 0;
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _eventListener_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventListener.js */ "./src/eventListener.js");


(0,_eventListener_js__WEBPACK_IMPORTED_MODULE_0__.onWindowLoad)()
